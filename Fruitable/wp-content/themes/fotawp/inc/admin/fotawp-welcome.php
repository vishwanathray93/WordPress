...
?>
			<div class="fotawp-admin-notice notice notice-info updated is-dismissible content-install-plugin theme-info-notice" id="fotawp-dismiss-notice">
				...
				<div class="info-content">
					<h6><span class="theme-name"><span><?php echo __('Welcome to FotaWP', 'fotawp'); ?></span> </h6>
					<h2><?php echo __('Start building your website with the most advanced WordPress theme ever! 🚀 ', 'fotawp'); ?></h2>

					<h3><?php echo __('Please install and activate all recommended plugins to use 40+ advanced blocks, 200+ pre-built sections, and 30+ starter site demos. Enhance website building and launch your site within minutes with just a few clicks! - Cozy Addons, Cozy Essential Addons, Advanced Import.', 'fotawp'); ?>
					</h3>
				...
				<div class="theme-screen">
					<img src="<?php echo esc_url(get_template_directory_uri() . '/inc/admin/images/cozy-template-stack.png'); ?>" />
				</div>
...
{
	if (! isset($_POST['nonce']) || ! wp_verify_nonce($_POST['nonce'], 'fotawp_admin_nonce')) {
		wp_send_json_error(array('message' => 'Nonce verification failed.'));
		return;
	}

	$result = update_option('fotawp_dismissed_custom_notice', 1);
...
function fotawp_install_and_activate_plugins()
{
	...
	check_ajax_referer('fotawp_welcome_nonce', 'nonce');
		...
		<div class="container">
			<div class="fotawp-dashboard-header">
				...
				<div class="theme-details">
					...
					<span class="new-features"><?php echo __('30+ Starter Sites ready to import with one click!', 'fotawp'); ?> </span>
					...
					<div id="tabs-content">
						<div id="fotawp-welcome" class="tab-content">
							...
							function fotawp_recommend_pluigns_activation_status($frp_slug, $frp_file)
							{
								...
								} elseif (fotawp_is_fr_plugin_activated($frp_slug . '/' . $frp_file)) {
									$frp_activation_link      = '#';
							...
							<div class="plugin-list">
								...
								<div class="frp_holder">
									...
									<div class="frp_holder_footer">
										<?php
										fotawp_recommend_pluigns_activation_status('cozy-addons', 'cozy-addons.php');
										echo '<br />';
										echo '<div style="margin-top:20px">' . __('Advanced 40+ blocks for FSE and Gutenberg Editor', 'fotawp') . '</div>';
										?>
